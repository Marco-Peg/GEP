...
from evaluation.evaluate import EPMPEvaluator, EGNNEvaluator
from preprocessing.data_utils import epipredDataset
...
def input_parser():
    ...
    # parser.add_argument("--path", default=f"correct_EPMP" + dateTimeObj.strftime("%d%b_%H_%M"))
